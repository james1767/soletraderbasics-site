---
title: "Sole Trader Record Keeping Requirements UK (2026)"
description: "A simple UK guide to HMRC record keeping for sole traders, including what records to keep and how long to keep them."
...
- records of business mileage, if relevant
- details of money taken out of or put into the business
- records about personal income needed for your Self Assessment
...
- work out your business profit or loss
- support the figures in your tax return
- show records to HMRC if they ask
...
| Tax year | Online filing deadline | Keep records until at least |
|---|---|---|
...
For more on what expenses might be relevant, read [what expenses can sole traders claim](/guides/tax/what-expenses-can-sole-traders-claim/).
...
- a spreadsheet
- accounting software
- receipt photos stored in folders
- invoice software
- bank statements from a separate account

For a simple manual setup, see the [bookkeeping spreadsheet template](/guides/accounting-software/bookkeeping-spreadsheet-template/). For a software approach, see [free bookkeeping software for sole traders](/guides/accounting-software/free-bookkeeping-software-sole-trader/).
...
A separate account can make this much easier because fewer personal transactions get mixed in. Read [business vs personal bank account for sole traders](/guides/banking/business-vs-personal-account-sole-trader/) if you are deciding what to use.
...
If you are just starting, read [sole trader bookkeeping UK](/guides/accounting-software/sole-trader-bookkeeping/) next for the beginner setup.
...
_Last updated: June 2026. Based on HMRC record-keeping guidance for self-employed people. Always check HMRC for the latest rules._
