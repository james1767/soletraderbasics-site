---
title: "Sole Trader Bookkeeping: What Records Do I Need to Keep?"
...
HMRC requires every sole trader to keep "adequate records" of their business income and expenses. That sounds vague — because it is. Here's exactly what you need, how long to keep it, and the simplest way to stay on top of it. This guide is part of our [accounting software and bookkeeping series](/guides/accounting-software/).

## What HMRC actually requires

You must keep records that show:

1. **All money received by the business** — every payment from clients, every sale, every source of income
2. **All money spent by the business** — every expense, every purchase, every cost
3. **What the income and expenses relate to** — enough detail that someone could understand each transaction
...
- **Photos of receipts** taken on your phone (most [accounting apps](/best/accounting-software-sole-trader/) have a receipt capture feature)
...
1. Create a spreadsheet with columns for: Date, Description, Category, Income, Expense, Receipt (Y/N)
2. Log every transaction as it happens (or weekly at minimum)
